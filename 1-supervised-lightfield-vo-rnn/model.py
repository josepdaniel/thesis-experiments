...
class OdometryNet(nn.Module):
    def __init__(self, imchannels, imsize1, imsize2, batchNorm=True):
        super(OdometryNet,self).__init__()
        # CNN
        self.batchNorm = batchNorm
        self.clip = True
        self.conv1   = conv(self.batchNorm,  imchannels*2,      64, kernel_size=7,   stride=2, dropout=0.2)
    ...
    def get_loss(self, x, y):
        ...
        loss = (lambda_theta * angle_loss + lambda_t * translation_loss)
        return loss, angle_loss*lambda_theta, translation_loss*lambda_t
